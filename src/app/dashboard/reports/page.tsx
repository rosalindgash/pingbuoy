      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white shadow-sm border border-gray-200 rounded-lg p-4 sm:p-6 mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-xl sm:text-3xl font-bold text-gray-900 mb-2">Reports</h1>
              <p className="text-sm sm:text-base text-gray-600">Generate detailed uptime and performance reports</p>
            </div>
