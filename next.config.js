        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "script-src-elem 'self' 'unsafe-inline' 'unsafe-eval' https://vercel-insights.com https://js.stripe.com",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: https:",
              "connect-src 'self' https://*.supabase.co https://*.upstash.io https://api.stripe.com https://js.stripe.com",
